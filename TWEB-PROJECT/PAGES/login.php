    ...
    <div class="forms">
      ...
      <div class="form-wrapper">
        ...
        <form action="signUP.php" method="post" class="form form-signup">
          ...
          <div class="error-message">
            <?php
            if (isset($_SESSION['account-error']) && $_SESSION['account-error']) {
              echo " <div style='background-color: red'> This email is already used. </div> ";
              $_SESSION['account-error'] = false;
            }
            if (isset($_SESSION['signup-error']) && $_SESSION['signup-error']) {
              echo " <div style='background-color: red'> Password doesn't match. </div> ";
